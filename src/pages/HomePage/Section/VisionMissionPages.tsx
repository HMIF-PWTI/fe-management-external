        ...
        <div className="space-y-6">
          <div>
            ...
            <h2 className="text-justify text-sm leading-relaxed">
              ...
              pengajaran teknologi informasi di lingkungan program studi teknik
              informatika serta terbentuknya insan akademis, pencipta dan
              pengabdi yang bertakwa kepada Tuhan Yang Maha Esa, berbudi luhur,
              beretos kerja, memiliki idealisme dan integritas yang tinggi.
            </h2>
          </div>
          <div>
