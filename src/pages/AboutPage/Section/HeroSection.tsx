  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center mb-20">
        <h1 className="text-4xl font-bold">KABINET DAKSHAWIRA</h1>
      ...
      <div className="relative bg-white px-36 py-10 min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="grid grid-cols-2 items-center gap-20 w-full">
          <div className="flex items-center justify-center relative">
            <img src={logo} className="w-1/2 z-10" alt="Logo HMIF" />
          </div>
          <div className="space-y-6">
            <div>
              <h1 className="text-primary2 text-2xl font-bold">Visi</h1>
            ...
            <div>
              <h1 className="text-primary2 text-2xl font-bold">Misi</h1>
              <hr className="mb-4 border-2 border-primary2 rounded-full w-20" />
